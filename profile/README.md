...
2.  **[verity-mobile](https://github.com/verity-hq/verity-mobile)**: A sophisticated **Flutter** mobile client. Features include personalized filtering, "Pay-with-Time" ad rewards (SSV), and a seamless onboarding flow.
